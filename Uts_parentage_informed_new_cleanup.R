...
Uts_informed_parents_new <- `2021.06.18.uts_informed.prior1.parents`
...
#write file
write.csv(Uts_parentage_informed_new_all, "C:/Users/kingsley/Dropbox/projects/Atlantic salmon - Teno River Pedigree/2020 - Utsjoki pedigree data/datacleanup/Uts_parentage_informed_new_21.06.22.csv")

...
Uts_default_parents <- read.csv("Data/uts_default.prior0.parents.2021-06-18.csv")
...
#write file
write.csv(Uts_parentage_default_all, "Data/Uts_parentage_default_21.06.22.csv")
